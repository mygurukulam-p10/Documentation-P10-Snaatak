...
2. [⚙️ Pre-requisites](#-pre-requisties)
...
### 3. 🚀 Add description about the pipelines.
<img width="947" alt="image" src="https://github.com/user-attachments/assets/df35108b-2228-48f0-86b5-bd310c3b9da7">

### 4. 🚀 Choose Pipeline and the script to perform cred scanning --> and clink on save.
...
### 7.🚀 Now click on console output to check the console report-
